...
public class Acciones extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String accion = request.getParameter("accion");
            if (accion.equals("menuprincipal")) {
            ...
            request.getRequestDispatcher("PAGES/VISTASHTML/Productos.jsp").forward(request, response);
        }
               if (accion.equals("proveedores")) {
            request.getRequestDispatcher("PAGES/VISTASHTML/MENUPRINCIPAL.jsp").forward(request, response);
        }
                if (accion.equals("marcas")) {
            request.getRequestDispatcher("PAGES/VISTASHTML/MENUPRINCIPAL.jsp").forward(request, response);
        }
    }
