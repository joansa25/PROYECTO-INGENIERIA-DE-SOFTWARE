        ...
        <body>
                ...
                <nav class="navbar ">
                        <div class="container-fluid">
                                <span class="navbar-brand mb-0 h1">MARCAS</span>
                                ...
                                <div class="card-body">
                                        <form action="Controlador?menu=Marcas" method="POST">
                                                <div class="form-group">
                                                        ...
                                                        <input type="text" value="${marca.getMarCod()}" name="txtMarCod" class="form-control">

                                                </div>
                                                <div class="form-group">
                                                        <label>Nombre Marca</label>
                                                        <input type="text" value="${marca.getMarNom()}" name="txtMarNom" class="form-control">
                                                </div>                           
